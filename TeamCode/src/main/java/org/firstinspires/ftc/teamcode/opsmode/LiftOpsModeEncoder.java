...
public class LiftOpsModeEncoder extends LinearOpMode {
     ...
     */
    public void encoderDrive(double speed, int encoderCounts, double timeoutS) {
        int newLeftTarget;
        ...
        if (opModeIsActive()) {
            ...
            newLeftTarget = liftDrive.getCurrentPosition() + encoderCounts;
            liftDrive.setTargetPosition(newLeftTarget);
